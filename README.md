...
│   └── tasks.json         # Задания в JSON формате
├── lesson3/                # Урок 3: Новые грамматические конструкции (НОВЫЙ)
│   ├── theory.html        # Теоретический материал со словарем
│   ├── hanzi.html         # Изучение иероглифов
│   ├── index.html         # Практические задания
│   └── tasks.json         # Задания в JSON формате
...
### 📚 Содержание:
- **Тема**: Новые грамматические конструкции
- **Иероглифы**: 12 новых служебных слов и грамматических показателей
- **Задания**: 20 разнообразных упражнений по грамматике

### 🎯 Типы заданий:
- Выбор правильного ответа
- Определение грамматической функции
- Соединение конструкций с значениями
